...
public class TimeSheetStaffPage extends TestBase {
	...
	public WebElement tableAction2;
	...
	@FindBy(xpath="(//span[@class='datatable-header-cell-wrapper float-left ng-star-inserted'])[1]")
	public WebElement checkBox;

	@FindBy(xpath="//img[@class='icon']")
	public WebElement icon;

	@FindBy(xpath="//input[@class=\"mat-input-element mat-form-field-autofill-control ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored\"]")
	public WebElement emailField;

	@FindBy(xpath="//button[@class='mat-focus-indicator mat-flat-button mat-button-base mat-primary']")
	public WebElement add;

	public void validateExportStaffTimeshett() throws InterruptedException {
		this.validatetimeSheetTabTest();
		dateListIcon.click();
		List<WebElement> allOptions = driver.findElements(By.xpath("//button[@class='mat-focus-indicator mat-menu-item']"));
		System.out.println(allOptions.size());
		...
		for(int i = 0; i<=allOptions.size()-1; i++) {
			Thread.sleep(1500);
			if(allOptions.get(i).getText().contains("Last 30 Days")) {
				System.out.println("xx");
